...
import '../../../page/feed/composeTweet/widget/composeBottomIconWidget.dart';
import '../../../page/feed/composeTweet/widget/composeTweetImage.dart';
import '../../../page/feed/composeTweet/widget/widgetView.dart';
...
//Reciviendo share de otras aplicaciones
  ...
  void initState() {
    ...
    //Listener de share de otras aplicaciones
    ...
    _intentDataStreamSubscription = ReceiveSharingIntent.getMediaStream()
      ...
      setState(() {
        _sharedFiles = value;
        if (value != null) {
          _image = new File(value[0].path);
        }

        print("Shared image 70:" +
    ...
    _intentDataStreamSubscription =
      ...
      setState(() {
        _sharedText = value;
        print("Shared line 90: $_sharedText");
      });
    }, onError: (err) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: customTitleText('Tus comentarios es revolución'),
        isCrossButton: true,
        /*onActionPressed: _submitButton,
        
        submitButtonText:
            widget.isTweet ? 'Publica' : widget.isRetweet ? 'Retweet' : 'Reply',
        isSubmitDisable:
...
class _ComposeTweet
    extends WidgetView<ComposeTweetPage, _ComposeTweetReplyPageState> {
  final String sharedFiles;

  _ComposeTweet(this.viewState, this.sharedFiles) : super(viewState);
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  UrlText(
                    text:
                        'Respondiendo a ${viewState.model.user.userName ?? viewState.model.user.displayName}',
                    style: TextStyle(
