...
class MenuDashboardPage extends StatefulWidget {
  ...
  MenuDashboardPage({this.user});
  @override
  _MenuDashboardPageState createState() => _MenuDashboardPageState(user: user);
}
...
class _MenuDashboardPageState extends State<MenuDashboardPage> with SingleTickerProviderStateMixin {
 ...
 _MenuDashboardPageState({this.user});
  @override
  void initState() {
    super.initState();
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: [
                      ...
                      Text(user.uid, style: TextStyle(fontSize: 24, color: Colors.white)),
